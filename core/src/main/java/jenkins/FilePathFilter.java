...
public abstract class FilePathFilter {
     ...
     */
    public boolean read(File f) { return false; }
     ...
     */
    public boolean write(File f) { return false; }
     ...
     * On POSIX, this corresponds to the 'w' permission of the file itself.
     */
    public boolean symlink(File f) { return false; }
     ...
     */
    public boolean mkdirs(File f) { return false; }
     ...
     * On POSIX, this corresponds to the 'w' permission of the parent directory.
     */
    public boolean create(File f) { return false; }
     ...
     */
    public boolean stat(File f) { return false; }
